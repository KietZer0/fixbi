...
def get_dataset(dataset_name, path='/database'):
    if dataset_name in ['amazon', 'dslr', 'webcam']:  # OFFICE-31
        ...
        tr_dataset = datasets.ImageFolder(path + '/office31/Office-31/' + dataset_name, data_transforms['train'])
        te_dataset = datasets.ImageFolder(path + '/office31/Office-31/' + dataset_name, data_transforms['test'])
